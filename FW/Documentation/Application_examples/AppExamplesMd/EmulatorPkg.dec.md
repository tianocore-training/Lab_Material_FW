...
##
```
## List of List of Defines,  Package Name, GUILD, Version ...
```
[Defines]
  ...
  PACKAGE_VERSION                = 0.1
```
## The Include section,there is an include directory for this package
```
[Includes]
  Include
```
## Library classes section, these are the libraries created by this package. Notice each is pointing to a .h file
```
...
```
## Guids section, Guids defined by this package
```
[Guids]
...
```
## PCDs Section, Declared by this package
```
[PcdsFeatureFlag]
