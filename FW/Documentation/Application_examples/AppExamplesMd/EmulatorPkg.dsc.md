...
!endif
```
## Dynamic PCDs Section, changing the default value by this package
```
...
!endif
```
## Adding more modules, etc. done by adding more sections to the end of the file
```
[Components]
MyDummyDriver/MyDummyDriver.inf
