...
# This flag is to enable or disable building of the UEFI Shell from ShellPkg.  
# These can be changed on the command line.
...
#  UEFI / EDK II Training
# or if BUILD NEW SHELL We need the PCD For the UEFI Shell 2.x the OLD EFI Shell is the Default
#
#. . .
...
[PcdsDynamicDefault.common.DEFAULT]
  ...
  gEfiNt32PkgTokenSpaceGuid.PcdWinNtGop|L"EDK II 1!EDK II 2"|VOID*|52
...
#!if $(BUILD_NEW_SHELL) == TRUE ##Always Build the Shell.inf file for the UEFI - EDK II Training
#   and use FDF to include or not include
# add the following at the end of the components section
